    ...
    <div className="container mx-auto px-4">
      <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center max-w-6xl mx-auto">
        ...
        <div className={p.reverse ? "md:order-1" : ""}>
          ...
          <h2 className="mb-4 leading-tight" style={{ fontSize: "clamp(2rem, 8vw, 3.5rem)", fontWeight: "900" }}>{p.title}</h2>
      ...
      <section className="band-ink relative overflow-hidden">
        <div className="container mx-auto px-4 pt-4 md:pt-8 pb-20 md:pb-32">
          <div className="max-w-5xl">
            ...
            <h1 className="mb-4 leading-tight tracking-tighter" style={{ fontSize: "clamp(3rem, 12vw, 8rem)", fontWeight: "900" }}>
      ...
      <section className="section-pad band-cream">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="mb-4" style={{ fontSize: "clamp(2.5rem, 9vw, 3.5rem)", fontWeight: "900" }}>
      ...
      <section className="section-pad" style={{ backgroundColor: "#1a1625" }}>
        <div className="container mx-auto px-4">
          <div className="cta-card max-w-4xl mx-auto">
            ...
            <h2 className="mb-4 text-white" style={{ fontSize: "clamp(2.5rem, 9vw, 3.5rem)", fontWeight: "900" }}>Ready to take <span className="accent-italic">control?</span></h2>
