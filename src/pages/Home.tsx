    ...
    <div className="container mx-auto px-4">
      <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center max-w-6xl mx-auto">
        ...
        <div className={p.reverse ? "md:order-1" : ""}>
          <p className="overline-label mb-4">{p.overline}</p>
          <h2 className="mb-8 text-4xl md:text-5xl font-black leading-tight">{p.title}</h2>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="band-ink relative overflow-hidden">
        <div className="container mx-auto px-4 pt-8 md:pt-16 pb-20 md:pb-32">
          <div className="max-w-5xl">
            <p className="overline-label mb-4">GIFTOVATE THERAPEUTICS LTD</p>
            <h1 className="mb-8 text-6xl md:text-7xl lg:text-8xl font-black leading-tight tracking-tighter">
      ...
      <section className="section-pad band-cream">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <p className="overline-label mb-6">EMPOWERING RELIEF</p>
            <h2 className="mb-8 text-5xl md:text-6xl font-black leading-tight">
      ...
      <section className="section-pad band-magenta">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <p className="overline-label mb-6">THE PATH TO CLINICAL EQUALITY</p>
            <h2 className="mb-8 text-4xl md:text-5xl font-black leading-tight">
      ...
      {/* CTA */}
      <section className="section-pad bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4">
          <div className="cta-card max-w-4xl mx-auto">
            <p className="overline-label mb-6" style={{ color: "#FDE68A" }}>JOIN THE MOVEMENT</p>
            <h2 className="mb-6 text-4xl md:text-5xl font-black leading-tight text-white">Ready to take <span className="accent-italic">control?</span></h2>
      ...
      <div className="bg-gradient-to-r from-slate-950 via-purple-950 to-slate-950 border-t border-purple-900/30">
        <Footer />
      </div>
    </div>
  );
